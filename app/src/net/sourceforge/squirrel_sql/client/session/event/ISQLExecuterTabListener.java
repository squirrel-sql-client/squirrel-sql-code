 ...
 */
public interface ISQLExecuterTabListener extends EventListener
{
	/**
	 ...
	 * @param	evt		The event.
	 */
	public void executerTabAdded(SQLExecuterTabEvent evt);
	 ...
	 * @param	evt		The event.
	 */
	public void executerTabRemoved(SQLExecuterTabEvent evt);
	 ...
	 * @param	evt		The event.
	 */
	public void executerTabActivated(SQLExecuterTabEvent evt);
}