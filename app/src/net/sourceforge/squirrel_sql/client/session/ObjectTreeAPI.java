...
//		}
//		_session.getSessionSheet().getObjectTreePanel().addToPopup(dboType, action);
//	}
//
//	/**
...
//			throw new IllegalArgumentException("Action == null");
//		}
//		_session.getSessionSheet().getObjectTreePanel().addToPopup(action);
//	}
//
//	/**
...
//		}
//		_session.getSessionSheet().getObjectTreePanel().addToPopup(dboType, menu);
//	}
//
//	/**
...
//			throw new IllegalArgumentException("JMenu == null");
//		}
//		_session.getSessionSheet().getObjectTreePanel().addToPopup(menu);
//	}
//
//	/**
