/*
 * SQLFilterCommand.java
 *
 * Created on April 5, 2003, 9:38 AM
 */
...
/**
 * This <CODE>ICommand</CODE> displays a dialog box that allows the user to enter a 'where' clause or
 * an 'order by' clause used when getting data via the 'Contents' tab.
 *
...
public class SQLFilterCommand implements ICommand
{
   ...
   */
	...
	public void execute()
	{
		SQLFilterSheetFactory.getInstance().showSheet(_session, _objectInfo);
	}
}
