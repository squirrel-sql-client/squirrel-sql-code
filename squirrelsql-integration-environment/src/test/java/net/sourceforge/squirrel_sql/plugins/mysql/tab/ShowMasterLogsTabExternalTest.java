...
public class ShowMasterLogsTabExternalTest extends AbstractBaseObjectTabExternalTest
{
	...
	protected BaseObjectTab getTabToTest() {
		return new ShowMasterLogsTab();
	}
	
	protected String getAlias() {
		// "show logs" works for MySQL 4, but not 5.  Apparently MySQL 5 deprecates this in favor of:
		// "SHOW ENGINE BDB LOGS"
		return AliasNames.MYSQL4_DEST_ALIAS_NAME;
	}
