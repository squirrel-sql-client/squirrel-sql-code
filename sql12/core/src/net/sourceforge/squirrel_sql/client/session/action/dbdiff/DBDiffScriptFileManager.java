 ...
 * 
 */
public class DBDiffScriptFileManager
{

	/** Logger for this class. */
	private final static ILogger s_log = LoggerController.createLogger(DBDiffScriptFileManager.class);
	...
	public DBDiffScriptFileManager()
	{
	}
