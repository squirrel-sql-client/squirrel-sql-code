package net.sourceforge.squirrel_sql.client.session.action.syntax.prefspanel;
/*
...
public class StyleMaintenancePanel extends JToolBar
{
	...
	public StyleMaintenancePanel(StylesList list, SquirrelResources rsrc)
	{
		_list = list;

		this.setFloatable(false);

		_boldChk = new JToggleButton(rsrc.getIcon(SquirrelResources.IImageNames.BOLD_IMAGE));
		//i18n[syntax.bold=Bold]
		_boldChk.setToolTipText(s_stringMgr.getString("syntax.bold"));
		_italicChk = new JToggleButton(rsrc.getIcon(SquirrelResources.IImageNames.ITALIC_IMAGE));
		//i18n[syntax.italic=Italic]
		_italicChk.setToolTipText(s_stringMgr.getString("syntax.italic"));

		_fontColorBtn = new JButton(rsrc.getIcon(SquirrelResources.IImageNames.FOREGROUND_IMAGE));
		//i18n[syntax.font=Select font color]
		_fontColorBtn.setToolTipText(s_stringMgr.getString("syntax.font"));
		_backgroundColorBtn = new JButton(rsrc.getIcon(SquirrelResources.IImageNames.BACKGROUND_IMAGE));
