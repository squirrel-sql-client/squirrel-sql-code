...
public class ScriptUtil
{
      ...
      try
      {
         ...
         for (IDatabaseObjectInfo dbObj : dbObjs)
         {
            ...
            for (int i = 0; i < infos.length; i++)
            {
               ...
               {
                  buf.append(getColumnName(infos[i], Main.getApplication().getSQLScriptPreferencesManager().getPreferences().isUseDoubleQuotes()));
               }
               else
               {
   ...
   {
      return getColumnName(info, Main.getApplication().getSQLScriptPreferencesManager().getPreferences().isUseDoubleQuotes());
   }
   ...
   {
      return getColumnName(columnName, Main.getApplication().getSQLScriptPreferencesManager().getPreferences().isUseDoubleQuotes());
   }
