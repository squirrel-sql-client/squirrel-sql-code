...
public class InQuotesAction extends SquirrelAction implements ISQLPanelAction
{
	...
	public InQuotesAction(IApplication app)
	{
		super(app);
	}
   ...
   public void setSQLPanel(ISQLPanelAPI panel)
   {
	...
	public void actionPerformed(ActionEvent evt)
	{
		if (_session != null)
		{
			try
			{
				//new InQuotesCommand(_session.getMainSQLPanelAPI(_plugin)).execute();
				new InQuotesCommand(FrameWorkAcessor.getSQLPanelAPI(_session), false).execute();
			}
			catch (Throwable ex)
			{
