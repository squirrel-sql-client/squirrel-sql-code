...
public class ImportFileChooserDialog extends JDialog
{
   ...
   private void buildUI(IResources resources)
   {
      ...
      _btnClipBoard = new JButton(s_stringMgr.getString("ImportFileChooserDialog.import.from.clipboard"), resources.getIcon(SquirrelResources.IImageNames.CLIPBOARD));
