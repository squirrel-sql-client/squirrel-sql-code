...
{
	private static final StringManager s_stringMgr = StringManagerFactory.getStringManager(FindSelectedAction.class);


   private ISession _session;
   private ISQLEntryPanel _sqlEntryPanel;

   public FindSelectedAction(ISQLEntryPanel sqlEntryPanel)
	{
		this();
      _sqlEntryPanel = sqlEntryPanel;
   }

   public FindSelectedAction()
	{
