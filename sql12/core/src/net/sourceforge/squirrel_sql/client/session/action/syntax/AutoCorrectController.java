...
public class AutoCorrectController
{
   ...
   public AutoCorrectController(Frame parent)
   {
      _dlg = new AutoCorrectDlg(parent);

      AutoCorrectData autoCorrectData = new AutoCorrectProvider().getAutoCorrectData();
   ...
   private void save()
   {
      ...
      new AutoCorrectProvider().setAutoCorrects(newAutoCorrects, _dlg.chkEnable.isSelected());
   }
