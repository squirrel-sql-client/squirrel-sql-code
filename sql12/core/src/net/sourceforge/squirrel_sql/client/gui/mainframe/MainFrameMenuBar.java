...
//	private final JMenu _editMenu;
   ...
   private JMenu createSessionMenu(Resources rsrc)
	{
      ...
      {
         menu.addSeparator();
         addToMenu(rsrc, MarkResultTabHeaderMatchingCurSqlAction.class, menu);
      }
   ...
   private JMenu createSessionWindowFileMenu(Resources rsrc)
   {
	...
	private JMenu createSavedSessionMenu(Resources rsrc)
	{
		...
		addToMenu(rsrc, SaveAndManageGroupOfSavedSessionsAction.class, menu);
		addToMenu(rsrc, SessionOpenManageDialogAction.class, menu);
		return menu;
	}
