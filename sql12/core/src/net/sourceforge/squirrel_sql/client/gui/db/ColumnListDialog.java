...
public class ColumnListDialog extends JDialog implements IDisposableDialog
{
   ...
   private interface i18n
   {
      ...
      String EXECUTE_BUTTON_LABEL = s_stringMgr.getString("ColumnListDialog.executeButtonLabel");
      //i18n[ColumnListDialog.cancelButtonLabel=Cancel]
      String CANCEL_BUTTON_LABEL = s_stringMgr.getString("ColumnListDialog.cancelButtonLabel");
      //i18n[ColumnListDialog.columnNameLabel=Column: ]
      String COLUMN_NAME_LABEL = s_stringMgr.getString("ColumnListDialog.columnNameLabel");
      //i18n[ColumnListDialog.dropErrorMessage=Can't drop all columns - a
      //table must have at least one column
      String DROP_ERROR_MESSAGE = s_stringMgr.getString("ColumnListDialog.dropErrorMessage");
      //i18n[ColumnListDialog.dropErrorTitle=Too Many Columns Selected]
      String DROP_ERROR_TITLE = s_stringMgr.getString("ColumnListDialog.dropErrorTitle");
      //i18n[ColumnListDialog.dropPrimaryKeyTitle=Drop Primary Key]
      String DROP_PRIMARY_KEY_TITLE = s_stringMgr.getString("ColumnListDialog.dropPrimaryKeyTitle");
      //i18n[ColumnListDialog.dropTitle=Select Column(s) To Drop]
      String DROP_TITLE = s_stringMgr.getString("ColumnListDialog.dropTitle");
      //i18n[ColumnDetailsDialog.modifyButtonLabel=Modify Column]
      String MODIFY_BUTTON_LABEL = s_stringMgr.getString("ColumnDetailsDialog.modifyButtonLabel");
      //i18n[ColumnListDialog.modifyTitle=Select Column To Modify]
      String MODIFY_TITLE = s_stringMgr.getString("ColumnListDialog.modifyTitle");
      //i18n[ColumnListDialog.primaryKeyTitle=Choose column(s) for primary key]
      String PRIMARY_KEY_TITLE = s_stringMgr.getString("ColumnListDialog.primaryKeyTitle");

      //i18n[ColumnListDialog.primaryKeyNameLabel=Primary Key Name: ]
      String PRIMARY_KEY_NAME_LABEL = s_stringMgr.getString("ColumnListDialog.primaryKeyNameLabel");

      //i18n[ColumnListDialog.showSQLButtonLabel=Show SQL]
      String SHOWSQL_BUTTON_LABEL = s_stringMgr.getString("ColumnListDialog.showSQLButtonLabel");
      //i18n[ColumnListDialog.tableNameLabel=Table Name: ]
      String TABLE_NAME_LABEL = s_stringMgr.getString("ColumnListDialog.tableNameLabel");
      //i18n[ColumnListDialog.editSQLButtonLabel=Edit SQL]
      String EDIT_BUTTON_LABEL =s_stringMgr.getString("ColumnListDialog.editSQLButtonLabel");
   }
