...
public class DataSetViewerEditableTablePanel extends DataSetViewerTablePanel
{
	...
	public void deleteRows(int[] rows)
	{
		...
		if (rows.length == 0)
		{
			JOptionPane.showMessageDialog(SwingUtilities.windowForComponent(getComponent()),
		...
		SortableTableModel sortableTableModel = (SortableTableModel) myJTable.getModel();
		sortableTableModel.deleteRows(rows);
