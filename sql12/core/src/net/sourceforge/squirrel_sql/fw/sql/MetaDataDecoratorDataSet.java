...
public class MetaDataDecoratorDataSet extends MetaDataDataSet
{
   ...
   private static interface i18n
   {
      ...
      String CLASS_NAME_LABEL = s_stringMgr.getString("MetaDataDecoratorDataSet.classNameLabel");
      //1i8n[MetaDataDecoratorDataSet.classPathLabel=JDBC Driver CLASSPATH]
      String CLASS_PATH_LABEL = s_stringMgr.getString("MetaDataDecoratorDataSet.classPathLabel");
      //i18n[MetaDataDecoratorDataSet.noJarFiles=No files specified in 'Extra ClassPath' tab for driver]
      String NO_JAR_FILES = s_stringMgr.getString("MetaDataDecoratorDataSet.noJarFiles");
   }
