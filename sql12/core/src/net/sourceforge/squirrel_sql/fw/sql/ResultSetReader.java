...
{
   private final static ILogger s_log = LoggerController.createLogger(ResultSetReader.class);
    ...
    * @param columnTypeName the type name of the column according to the ResultSetMetaData
