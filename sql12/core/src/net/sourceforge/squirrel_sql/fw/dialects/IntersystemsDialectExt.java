 ...
 */
public abstract class IntersystemsDialectExt extends CommonHibernateDialect
{
   private class IntersystemsHelper extends net.sourceforge.squirrel_sql.fw.dialects.fromhibernate3_2_4_sp1.dialect.Cache71Dialect {
      public IntersystemsHelper() {
         super();
   ...
   private IntersystemsHelper _dialect = new IntersystemsHelper();
