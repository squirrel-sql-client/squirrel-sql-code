...
/*  */
/*   Target Database:   sas */
/*   Generated at:      Sat Dec 18 19:49:27 2004 */
...
/*     Generated at:      Sat Dec 18 19:49:19 2004 */
/*     Input Files:       TestERD.dia */
...
/* revoke all on imageInfo from fmorg for sas */
/* revoke select on imageInfo from public for sas */
/* revoke all on subImageInfo from fmorg for sas */
/* revoke all on imageCategoryList from fmorg for sas */
/* revoke select on categoryNames from public for sas */
/* revoke all on categoryNames from fmorg for sas */
/* revoke all on imageAttribute from fmorg for sas */
/* revoke all on userInfo from fmorg for sas */
/* revoke all on userAttribute from fmorg for sas */
/* revoke all on userImageRating from fmorg for sas */
/* revoke all on attributeCategory from fmorg for sas */
/* revoke all on userSession from fmorg for sas */
/* revoke select on extremes from public for sas */
/* revoke all on extremes from fmorg for sas */
...
drop view ratings_view cascade ;
drop view whorated_view cascade ;
...
drop table subImageInfo cascade ;
drop table imageCategoryList cascade ;
drop table categoryNames cascade ;
drop table imageAttribute cascade ;
drop table userInfo cascade ;
drop table userAttribute cascade ;
drop table userImageRating cascade ;
drop table attributeCategory cascade ;
drop table userSession cascade ;
drop table extremes cascade ;
...
/* grant all on imageInfo to fmorg for sas */
/* grant select on imageInfo to public for sas */
/* grant all on subImageInfo to fmorg for sas */
/* grant all on imageCategoryList to fmorg for sas */
/* grant select on categoryNames to public for sas */
/* grant all on categoryNames to fmorg for sas */
/* grant all on imageAttribute to fmorg for sas */
/* grant all on userInfo to fmorg for sas */
/* grant all on userAttribute to fmorg for sas */
/* grant all on userImageRating to fmorg for sas */
/* grant all on attributeCategory to fmorg for sas */
/* grant all on userSession to fmorg for sas */
/* grant select on extremes to public for sas */
/* grant all on extremes to fmorg for sas */
...
/* sas requires a special 'quit' command */
quit;
