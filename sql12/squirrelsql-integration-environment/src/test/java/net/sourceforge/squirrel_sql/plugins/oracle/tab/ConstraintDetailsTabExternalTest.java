...
public class ConstraintDetailsTabExternalTest extends AbstractBasePreparedStatementTabExternalTest
{
	...
	protected BasePreparedStatementTab getTabToTest() {
		return new ConstraintColumnInfoTab();
	}
	
	protected String getAlias() {
		return AliasNames.ORACLE_DEST_ALIAS_NAME;
	}
