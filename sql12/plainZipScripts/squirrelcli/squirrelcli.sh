...
$JAVA_HOME/bin/java -cp "$UNIX_STYLE_HOME/../lib/versioncheck.jar" JavaVersionChecker 1.8 9 10 11 12 13 14 15
if [ "$?" != "0" ]; then
  exit
fi
...
if [ $# == 0 ]; then
   ...
   echo "Entering Java 9 JShell based mode. JAVA 9 is or higher required."
