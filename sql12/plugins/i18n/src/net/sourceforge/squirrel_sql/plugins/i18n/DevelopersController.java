...
public class DevelopersController
{
	...
	public DevelopersController(DevelopersPanel pnlDevelopers)
	{
		...
		String sourceDir = Props.getString(PREF_KEY_SOURCE_DIR, null);
	...
	private void appendProps(File sourceDir)
	{
		...
		try
		{
			...
			if(0 < newProps.size() || 0 <replaceProps.size())
			{
                ...
                String includeTimestamp = Props.getString(PREF_KEY_INCLUDE_TIMESTAMP, "true");
	...
	{
		Props.putString(PREF_KEY_SOURCE_DIR, _panel.txtSourceDir.getText());
	}
