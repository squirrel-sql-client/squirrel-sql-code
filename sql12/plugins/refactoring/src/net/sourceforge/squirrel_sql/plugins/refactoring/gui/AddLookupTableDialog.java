...
public class AddLookupTableDialog extends AbstractRefactoringTabbedDialog {
    ...
    static interface i18n {
        ...
        String SOURCE_MODE_REPLACE_TOOLTIP = s_stringMgr.getString("AddLookupTableDialog.sourceModeReplaceTooltip");
        ...
        String LOOKUP_COLUMNSTABLE_HEADER1 = s_stringMgr.getString("AddLookupTableDialog.lookupColumnsTableHeader1");
        String LOOKUP_COLUMNSTABLE_HEADER2 = s_stringMgr.getString("AddLookupTableDialog.lookupColumnsTableHeader2");
        String BEHAVIOUR_DROP_LABEL = s_stringMgr.getString("AddLookupTableDialog.behaviourDropLabel");
        String BEHAVIOUR_DROP_CASCADE_LABEL = s_stringMgr.getString("AddLookupTableDialog.behaviourDropCascadeLabel");
        String BEHAVIOUR_DROP_CASCADE_TOOLIP = s_stringMgr.getString("AddLookupTableDialog.behaviourDropCascadeToolTip");
    }
        ...
        private class ModeItemListener implements ItemListener {
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    ...
                    if (e.getItem().equals(_replaceRadioButton)) pane.addTab(i18n.BEHAVIOUR_LABEL, _behaviourTab);
                    else pane.remove(_behaviourTab);
                }
            }
        }
    }
    ...
    private class LookupTab extends JPanel {
        ...
        class ColumnTableModel extends AbstractTableModel {
            ...
            private final String[] _columnNames = {i18n.LOOKUP_COLUMNSTABLE_HEADER1, i18n.LOOKUP_COLUMNSTABLE_HEADER2};
