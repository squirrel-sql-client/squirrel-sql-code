...
/**
 * Base class for all diff commmands which commonly require access to the IPluginPreferencesManager to access
 * the plugin preferences
 */
public abstract class AbstractDiffCommand
{
	/** Plugin preferences manager which allows the command to access plugin preferences */
