...
public class OracleAliasPrefsPanel extends JPanel
{
   ...
   public OracleAliasPrefsPanel()
   {
      ...
      gbc = new GridBagConstraints(0,0,1,1,1,0,GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(5,5,30,5),0,0);
      ...
      gbc = new GridBagConstraints(0,4,1,1,0,0,GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(15,5,5,5),0,0);
