...
public class SessionDetailsTab extends BasePreparedStatementTab
{
	...
	private static String SQL =
		"select sid, user#, username, status, server, schemaname, osuser, machine, terminal, program"
			+ " from sys.v_$session where audsid = ?";
	...
	public SessionDetailsTab(long audSid)
	{
	...
	/**
	 * @see net.sourceforge.squirrel_sql.client.session.mainpanel.objecttree.tabs.BasePreparedStatementTab#
	 * createStatement()
	 */
