 ...
 */
public class UDFDetailTab extends BasePreparedStatementTab
{
	// Internationalized strings for this class
	private static final StringManager s_stringMgr = StringManagerFactory.getStringManager(UDFDetailTab.class);

  	// This interface defines locale specific strings
	private interface i18n
	{
		String HINT  = s_stringMgr.getString("UDFDetailTab.hint");
		String TITLE = s_stringMgr.getString("UDFDetailTab.title"); 
	}
