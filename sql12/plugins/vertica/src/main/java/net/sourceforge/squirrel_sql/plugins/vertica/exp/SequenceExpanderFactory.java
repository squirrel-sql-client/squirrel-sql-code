...
import net.sourceforge.squirrel_sql.plugins.vertica.exp.SequenceParentExtractor;

/**
 * Implementation of INodeExpanderFactory for Vertica system tables
 * 
 */
public class SequenceExpanderFactory implements INodeExpanderFactory
{
	...
	public INodeExpander createExpander(DatabaseObjectType type)
	{
		...
		result.setExtractor(new SequenceParentExtractor());
		return result;
	}
