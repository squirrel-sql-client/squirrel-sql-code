...
import net.sourceforge.squirrel_sql.plugins.vertica.exp.UDFParentExpander;

/**
 * Implementation of INodeExpanderFactory for Vertica system tables
 * 
 */
public class UDFExpanderFactory implements INodeExpanderFactory
{
