...
import net.sourceforge.squirrel_sql.plugins.vertica.exp.SysTableParentExpander;

/**
 * Implementation of INodeExpanderFactory for Vertica system tables
 * 
 */
public class SysTableExpanderFactory implements INodeExpanderFactory
{
	...
	{
		return new SysTableParentExpander();
	}
