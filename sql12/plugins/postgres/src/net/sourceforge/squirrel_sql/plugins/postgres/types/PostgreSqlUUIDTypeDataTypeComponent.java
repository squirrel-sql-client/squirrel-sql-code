...
/**
 * A custom DatatType implementation of IDataTypeComponent that can handle Postgres UUIDS
 * 
 * @author jarmolow
 */
public class PostgreSqlUUIDTypeDataTypeComponent extends BaseDataTypeComponent implements IDataTypeComponent {
    ...
    private static final StringManager s_stringMgr = StringManagerFactory
        .getStringManager(PostgreSqlUUIDTypeDataTypeComponent.class);
    ...
    public PostgreSqlUUIDTypeDataTypeComponent() {
    }
     ...
     */
    @Override
    public void setPreparedStatementValue(final PreparedStatement pstmt, final Object value, final int position)
        throws SQLException {
        if (value == null) {
