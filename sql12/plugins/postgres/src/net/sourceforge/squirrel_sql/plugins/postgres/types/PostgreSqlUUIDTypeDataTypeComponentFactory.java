...
/**
 * A factory that creates PostgreSqlUUIDTypeDataTypeComponents for rendering uuid columns.
 * 
 * @author manningr
 */
public class PostgreSqlUUIDTypeDataTypeComponentFactory implements IDataTypeComponentFactory {

    /**
     * @param typeName
     */
    public PostgreSqlUUIDTypeDataTypeComponentFactory() {
    }
    ...
    public IDataTypeComponent constructDataTypeComponent() {
        return new PostgreSqlUUIDTypeDataTypeComponent();
    }
