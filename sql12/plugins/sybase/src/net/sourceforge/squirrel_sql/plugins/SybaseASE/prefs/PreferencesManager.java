...
public class PreferencesManager {
    ...
    private static SybasePreferenceBean _prefs = null;
    ...
    public static SybasePreferenceBean getPreferences() {
        return _prefs;
    }
    ...
    private static void loadPrefs() {
        try {
            ...
            doc.load(prefFile, SybasePreferenceBean.class.getClassLoader());            
                        
            Iterator it = doc.iterator();
            if (it.hasNext()) {
                _prefs = (SybasePreferenceBean)it.next();
            }
        ...
        if (_prefs == null) {
            _prefs = new SybasePreferenceBean();
        }
