...
//		LoggerController.createLogger(CopyTableCommand.class);
    ...
    private void listFieldsValueChanged(
            @SuppressWarnings("unused") javax.swing.event.ListSelectionEvent evt) {

    }

    //Set the list disabled if allfields of table are to be copied
    private void chAllFieldsActionPerformed(@SuppressWarnings("unused") java.awt.event.ActionEvent evt) {
    ...
    private void rdStructureDataActionPerformed(@SuppressWarnings("unused") java.awt.event.ActionEvent evt) {
        isStructure = !rdStructureData.isSelected();
    }

    private void rdStructureActionPerformed(@SuppressWarnings("unused") java.awt.event.ActionEvent evt) {
        isStructure = rdStructure.isSelected();
    }

    private void buttonCancelActionPerformed(@SuppressWarnings("unused") java.awt.event.ActionEvent evt) {
        jd.setVisible(false);
        jd.dispose();
    }
    ...
    public String getQuery() {
        ...
        String primaryKeyData = dbUtils.getPrimaryKeyColumn();
     ...
     * Closes the dialog
     */
    private void closeDialog(@SuppressWarnings("unused") java.awt.event.WindowEvent evt) {
        jd.setVisible(false);
        jd.dispose();
    }
