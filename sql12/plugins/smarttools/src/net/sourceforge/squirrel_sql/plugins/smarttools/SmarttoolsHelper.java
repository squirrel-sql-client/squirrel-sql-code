...
public class SmarttoolsHelper
{
	 ...
	 *           string to convert
	 * @param defaultValue
	 *           default value which will be returned on an exception
	 ...
	 *           JComboBox to fill
	 * @param usedGroup
	 *           data type group (@see STDataType)
	 */
	 ...
	 *           data to generate the readable data type info
	 ...
	 * @param sql
	 *           SQL-Statement for executeQuery
	 ...
	 *           JTable
	 * @param col
	 *           column to mark or demark
	 * @param mark
	 *           true=mark; false=demark
	 */
