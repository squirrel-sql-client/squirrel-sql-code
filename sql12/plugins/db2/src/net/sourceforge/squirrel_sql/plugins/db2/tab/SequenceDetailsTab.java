...
public class SequenceDetailsTab extends BasePreparedStatementTab
{
	...
	private final static ILogger s_log = LoggerController.createLogger(SequenceDetailsTab.class);

 	/** Object that contains methods for retrieving SQL that works for each DB2 platform */
 	private final DB2Sql db2Sql;
	
	public SequenceDetailsTab(DB2Sql db2Sql)
	{
	...
	protected PreparedStatement createStatement() throws SQLException
	{
		...
		String sql = db2Sql.getSequenceDetailsSql();
