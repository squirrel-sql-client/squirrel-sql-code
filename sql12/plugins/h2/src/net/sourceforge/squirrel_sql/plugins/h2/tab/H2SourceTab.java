 ...
 *
 */
public abstract class H2SourceTab extends BaseSourceTab {

	private static final StringManager s_stringMgr =
		StringManagerFactory.getStringManager(H2SourceTab.class);
    ...
    private final static ILogger s_log =
        LoggerController.createLogger(H2SourceTab.class);
    ...
    public H2SourceTab(String hint)
    {
        super(hint);
