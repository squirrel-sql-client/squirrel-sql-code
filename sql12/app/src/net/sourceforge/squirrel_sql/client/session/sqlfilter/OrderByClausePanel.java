/*
 * OrderByClausePanel.java
 *
 * Created on April 5, 2003, 10:55 AM
 */
...
public class OrderByClausePanel	implements ISQLFilterPanel
{
  ...
  /** A private class that makes up the bulk of the GUI for the panel. */  
     ...
     */    
		...
		{
      _orderClauseArea.setText(sqlFilterClauses.get(getClauseIdentifier(), _tableName));
		}
     ...
     */    
		...
		{
      sqlFilterClauses.put(getClauseIdentifier(), _tableName, _orderClauseArea.getText());
		}
