...
class SchemaTableCboItem
{
   ...
   {
      new SchemaTableCboItem(SQLAlias.SCHEMA_ID_LOAD_DONT_CACHE),
      new SchemaTableCboItem(SQLAlias.SCHEMA_ID_LOAD_AND_CACHE),
      new SchemaTableCboItem(SQLAlias.SCHEMA_ID_DONT_LOAD),
   };
   ...
   static SchemaTableCboItem getItemForID(int schemaID)
   {
      switch(schemaID)
      {
         case SQLAlias.SCHEMA_ID_LOAD_DONT_CACHE:
            return SchemaTableCboItem.items[0];
         case SQLAlias.SCHEMA_ID_LOAD_AND_CACHE:
            return SchemaTableCboItem.items[1];
         case SQLAlias.SCHEMA_ID_DONT_LOAD:
