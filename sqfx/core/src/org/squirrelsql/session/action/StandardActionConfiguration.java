...
public enum StandardActionConfiguration
{
   ...
   EXEC_BOOKMARK(new ActionConfiguration(null, null, ActionScope.SQL_EDITOR, new KeyCodeCombination(KeyCode.K, KeyCodeCombination.CONTROL_DOWN))); // Should be J instead of K but because of KeyMatchWA.checkFunnyCharacterShiftingByCtrl() J is the same as Enter
