...
public class PreferencesManager {
    ...
    private static DBDiffPreferenceBean _prefs = null;
    ...
    public static DBDiffPreferenceBean getPreferences() {
        return _prefs;
    }
    ...
    private static void loadPrefs() {
        try {
            ...
            doc.load(prefFile, DBDiffPreferenceBean.class.getClassLoader());
