 ...
 */
class CheckTableAction extends SquirrelAction implements ISessionAction
{
	...
	static final class ChangedCheckTableAction extends CheckTableAction
	{
		ChangedCheckTableAction(IApplication app, Resources rsrc,
										MysqlPlugin plugin)
		{
	...
	static final class ExtendedCheckTableAction extends CheckTableAction
	{
		ExtendedCheckTableAction(IApplication app, Resources rsrc,
										MysqlPlugin plugin)
		{
	...
	static final class FastCheckTableAction extends CheckTableAction
	{
		FastCheckTableAction(IApplication app, Resources rsrc,
										MysqlPlugin plugin)
		{
	...
	static final class MediumCheckTableAction extends CheckTableAction
	{
		MediumCheckTableAction(IApplication app, Resources rsrc,
										MysqlPlugin plugin)
		{
	...
	static final class QuickCheckTableAction extends CheckTableAction
	{
		QuickCheckTableAction(IApplication app, Resources rsrc,
										MysqlPlugin plugin)
		{
