...
public class MSSQLGlobalPreferencesTab implements IGlobalPreferencesPanel {

    PreferencesPanel prefs = null;
    private JScrollPane _myscrolledPanel;
    
    private static final StringManager s_stringMgr =
        StringManagerFactory.getStringManager(MSSQLGlobalPreferencesTab.class);    
    
    public MSSQLGlobalPreferencesTab() {
    ...
    public String getTitle() {
        //i18n[MSSQLGlobalPreferencesTab.title=MS SQL-Server]
        return s_stringMgr.getString("MSSQLGlobalPreferencesTab.title");
    }
    ...
    public String getHint() {
        // i18n[MSSQLGlobalPreferencesTab.hint=Preferences for MS SQL-Server]
        return s_stringMgr.getString("MSSQLGlobalPreferencesTab.hint"); 
    }
