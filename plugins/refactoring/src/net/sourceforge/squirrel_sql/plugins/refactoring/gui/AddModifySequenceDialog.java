...
public class AddModifySequenceDialog extends AbstractRefactoringDialog {
    ...
    static interface i18n {
        ...
        String SEQUENCE_NAME_LABEL =
                s_stringMgr.getString("AddSequenceDialog.sequenceNameLabel");

        String INCREMENT_LABEL =
                s_stringMgr.getString("AddSequenceDialog.incrementLabel");

        String START_LABEL =
                s_stringMgr.getString("AddSequenceDialog.startLabel");

        String RESTART_LABEL =
                s_stringMgr.getString("AddSequenceDialog.reStartLabel");

        String MINIMUM_LABEL =
                s_stringMgr.getString("AddSequenceDialog.minimumLabel");

        String MAXIMUM_LABEL =
                s_stringMgr.getString("AddSequenceDialog.maximumLabel");

        String CACHE_LABEL =
                s_stringMgr.getString("AddSequenceDialog.cacheLabel");

        String CYCLED_LABEL =
                s_stringMgr.getString("AddSequenceDialog.cycledLabel");
    }
     ...
     *
     * @param dialogMode mode in which the dialog should be run.
     */
     ...
     * @param increment    increment value of the sequence.
     * @param minimum      minimum value of the sequence.
     * @param maximum      maximum value of the sequence.
     * @param cache        cache value of the sequence.
     * @param cylced       cycled value of the sequence.
     */
    public AddModifySequenceDialog(int dialogMode, String sequenceName, String increment, String minimum, String maximum, String cache, boolean cylced) {
        this(dialogMode);
    ...
    protected void init() {
        ...
        if (_dialogMode == MODIFY_MODE) _nameField.setEnabled(false);
