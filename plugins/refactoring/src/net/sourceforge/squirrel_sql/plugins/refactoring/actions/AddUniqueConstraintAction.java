...
public class AddUniqueConstraintAction extends AbstractRefactoringAction {
     ...
     */
    private static final StringManager s_stringMgr = StringManagerFactory.getStringManager(AddUniqueConstraintAction.class);
    ...
    private static interface i18n {
        ...
        String SINGLE_OBJECT_MESSAGE = s_stringMgr.getString("Shared.singleObjectMessage", i18n.OBJECT_PART, i18n.ACTION_PART);
    }
