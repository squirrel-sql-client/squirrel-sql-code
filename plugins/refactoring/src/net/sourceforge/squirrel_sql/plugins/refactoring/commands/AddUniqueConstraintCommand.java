...
public class AddUniqueConstraintCommand extends AbstractRefactoringCommand {
    ...
    protected void showCustomDialog() throws SQLException {
        ...
        customDialog = new AddUniqueConstraintDialog(selectedTable.getSimpleName(), localColumns.toArray(new String[]{}));
    ...
    protected String[] generateSQLStatements() throws UserCancelledOperationException {
        ...
        String result = _dialect.getAddUniqueConstraintSQL(_info[0].getSimpleName(), customDialog.getConstraintName(),
                customDialog.getUniqueColumns().toArray(new String[]{}), qualifier, _sqlPrefs);
