...
// DELETEME: once no longer required by dataset classes.
public abstract class BaseMDIParentFrame extends JFrame
{
	protected BaseMDIParentFrame(String title)
	{
		super(title);
	}
	 ...
	 */
	public abstract void addInternalFrame(JInternalFrame child, boolean createMenuItem);
