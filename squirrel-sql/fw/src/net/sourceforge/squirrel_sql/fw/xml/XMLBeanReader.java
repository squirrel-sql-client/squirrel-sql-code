...
//      try {
            ...
            _beanColl.clear();
            if (xmlFileName == null) {
                throw new XMLException("Null File name"); //i18n.
            }

//          final IXMLParser parser = XMLParserFactory.createDefaultXMLParser();
            //final IXMLReader rdr = StdXMLReader.fileReader(xmlFileName);
            FileReader frdr = new FileReader(xmlFileName);
            try {
                load(frdr, cl);
/*
                parser.setReader(new StdXMLReader(frdr));
...
//      }
    ...
    private Object loadBean(IXMLElement beanElement)
            throws XMLException {
        try {
    ...
    private void loadProperty(Object bean, PropertyDescriptor propDescr,
