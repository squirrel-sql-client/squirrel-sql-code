...
class NumericFunctionsTab extends BaseDatabasePanelTab
{
	/**
	...
	private static ILogger s_log =
		LoggerController.createLogger(NumericFunctionsTab.class);
...
//		try
//		{
//			return session.getSQLConnection().createNumericFunctionsDataSet(
