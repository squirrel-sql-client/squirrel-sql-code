...
public class KeywordsTab extends BaseDatabasePanelTab {
	...
	private interface i18n {
		...
		String HINT = "Show all the database's SQL keywords that are NOT also SQL92 keywords";
	}

	/** Logger for this class. */
	private static ILogger s_log = LoggerController.createLogger(KeywordsTab.class);
	...
	protected IDataSet createDataSet(ISession session) throws DataSetException {
		try {
			return session.getSQLConnection().createSQLKeywordsDataSet(session.getMessageHandler());
