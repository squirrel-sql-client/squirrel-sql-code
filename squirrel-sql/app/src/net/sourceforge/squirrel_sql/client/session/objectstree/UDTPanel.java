...
class UDTPanel extends PropertyPanel
{
	...
	{
		if (value instanceof IUDTInfo)
		{
			setUDTInfo((IUDTInfo) value);
		}
	}
	...
	void setUDTInfo(IUDTInfo value)
	{
		...
		_catalogLbl.setText(
			value != null ? getString(value.getCatalogName()) : "");
		_schemaLbl.setText(
			value != null ? getString(value.getSchemaName()) : "");
		_javaClassNameLbl.setText(
			value != null ? getString(value.getJavaClassName()) : "");
		_dataTypeLbl.setText(
			value != null ? getString(value.getDataType()) : "");
	...
	private void createUserInterface()
	{
		...
		add(
			new JLabel(i18n.JAVA_CLASS_NAME, SwingConstants.RIGHT),
			_javaClassNameLbl);
