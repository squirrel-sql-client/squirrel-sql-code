...
public class SQLValidatorPlugin extends DefaultSessionPlugin
{
	...
	public synchronized void initialize() throws PluginException
	{
		...
		Action action = new ValidateSQLAction(app, _resources, _prefs, this);
		coll.add(action);
	...
	public void sessionCreated(ISession session)
	{
		...
		WebServiceSessionProperties props = new WebServiceSessionProperties();
	...
	WebServiceSessionProperties getSessionProperties(ISession session)
	{
		if (session == null)
		{
