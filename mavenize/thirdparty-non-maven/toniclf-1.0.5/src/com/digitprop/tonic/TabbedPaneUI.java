...
//				g.setColor(darkShadow);
					...
					for (int i= 0; i < numChildren; i++)
					{
						...
						if (child instanceof ScrollableTabViewport)
						{
							...
							switch (tabPlacement)
							{
								...
								default :
									int totalTabWidth=
										rects[tabCount - 1].x + rects[tabCount - 1].width;
									if (totalTabWidth > tw)
									{
						...
						else if (child instanceof ScrollableTabButton)
						{
							...
							switch (tabPlacement)
							{
								...
								case RIGHT :
									...
									{
										int dir=
											scrollbutton.scrollsForward() ? SOUTH : NORTH;
	...
	private class ScrollableTabSupport implements ChangeListener
	{
		...
		public void setLeadingTabIndex(int tabPlacement, int index)
		{
			...
			switch (tabPlacement)
			{
				...
				case BOTTOM :
					tabViewPosition.x=
						leadingTabIndex == 0 ? 0 : rects[leadingTabIndex].x;
					...
					if ((viewSize.width - tabViewPosition.x) < viewRect.width)
					{
						...
						Dimension extentSize=
							new Dimension(
								viewSize.width - tabViewPosition.x,
								viewRect.height);
				...
				case RIGHT :
					tabViewPosition.y=
						leadingTabIndex == 0 ? 0 : rects[leadingTabIndex].y;
	...
	private class ScrollableTabPanel extends JPanel implements UIResource
	{
		...
		public void paintComponent(Graphics g)
		{
			...
			TabbedPaneUI.this.paintTabArea(
				g,
